...
BMPFileHeader()
: file_type(0x4D42), file_size(0), reserved1(0), reserved2(0), offset_data(0)
{}
};
...
BMPInfoHeader()
: size(0), width(0), height(0), planes(1), bit_count(0), compression(0),
size_image(0), x_pixels_per_meter(0), y_pixels_per_meter(0),
